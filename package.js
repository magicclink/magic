        ...
        log: function() {
            if (this.config.debug) {
                console.log('[LinkMagico Widget]', ...arguments);
            }
        },
 ...
 * LinkMágico ChatBot Widget v6.0
 * Professional floating chat widget for external websites
 * 
 * Features:
 * - Floating chat button with customizable position
 * - Full chat interface with professional design
 * - Auto-resize and mobile responsive
 ...
 *     salesUrl: 'https://example.com/produto',
 *     instructions: 'Responda em até 3 frases',
 *     position: 'bottom-right',
 *     primaryColor: '#667eea',
 *     apiBase: 'https://your-linkmagico-server.com'
 *   };
 *   var script = document.createElement('script');
 *   script.src = 'https://your-linkmagico-server.com/widget.js';
 *   script.onload = function() { window.LinkMagicoWidget.init(config); };
